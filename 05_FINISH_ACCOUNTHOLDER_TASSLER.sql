--------------------------
-- CLIENT_ACCOUNTHOLDER_TASSLER --
--------------------------
-- CI START FOR ALL TAPES
-- Drop View
drop view AMC.TAPE_CLIENT_ACCOUNTHOLDER_TASSLER;
-- View erstellen
create or replace view AMC.TAPE_CLIENT_ACCOUNTHOLDER_TASSLER as
select distinct
    ...
    CLIENT_NAME_ANONYMIZED as BORROWERNAME,         -- Kundenname - Anonymisiert Mitarbeiter und Singapur Kunden
    KONZERN_ID,                                     -- Konzern-ID
    KONZERN_BEZEICHNUNG,                            -- Konzern-Bezeichnung
