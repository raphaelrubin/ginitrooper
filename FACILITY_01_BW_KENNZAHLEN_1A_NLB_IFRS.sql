-- View erstellen
drop view CALC.VIEW_NLB_IFRS;
create view CALC.VIEW_NLB_IFRS as (
        select distinct
...
-- Tabelle erstellen
call STG.TEST_PROC_BACKUP_AND_DROP('AMC','TABLE_NLB_IFRS_CURRENT');
create table AMC.TABLE_NLB_IFRS_CURRENT like CALC.VIEW_NLB_IFRS distribute by hash(CS_ITEM) in SPACE_AMC_A,SPACE_AMC_B,SPACE_AMC_C,SPACE_AMC_D,SPACE_AMC_E,SPACE_AMC_F;
create index AMC.INDEX_NLB_IFRS_CURRENT_CS_ITEM on AMC.TABLE_NLB_IFRS_CURRENT (CS_ITEM);
call STG.TEST_PROC_LOAD_AND_DROP_BACKUP_FOR('AMC','TABLE_NLB_IFRS_CURRENT');
-- CI END FOR ALL TAPES

-- SWITCH View erstellen
call STG.TEST_PROC_DROP_AND_CREATE_SWITCH('AMC','TABLE_NLB_IFRS_CURRENT');